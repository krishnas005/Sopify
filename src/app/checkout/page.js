...
export default function Checkout() {
    ...
    const [isOrderProcessing, setIsOrderProcessing] = useState(null)
    const [orderSuccess, setOrderSuccess] = useState(false)
    const router = useRouter();
    const [paymentDone, setPaymentDone] = useState(false)

    const key = "pk_test_51ORGemSE6m9hYGP4ovpoOAPjeaBaEps99h0eRuAGraKTWX4dpKoXiKikZSINn4gGtk5VgjlKTjV3u6skEpFYHf4i006iADLBCz";
    ...
    //                         <div className='mx-auto px-4 sm:px-6 lg:p-8'>
    //                             <div className="mx-auto mt-8 max-w-screen-xl p-4 sm:px-6 lg:px-8">
                            ...
                            cartItems && cartItems.length ?
                                cartItems.map((item) => (
                                    <div
                                        ...
                                        key={item._id}>
                                        <img src={item && item.productID && item.productID.imageUrl} alt='Cart Item'
